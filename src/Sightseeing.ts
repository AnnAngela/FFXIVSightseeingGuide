...
export const SightseeingData: ISightseeingGroup[] = [
    {
        ...
        items: [
            ...
            { id: "10", area: "area.Gridania", subarea: "area.OldGridania", pos: { x: 10, y: 6 }, weather: "weather.ClearSkies", time: [0, 1, 2, 3, 4, 18, 19, 20, 21, 22, 23], action: "action.Lookout", timestr: "18:00~5:00", startHour: 18, endHour: 5 },
            ...
            { id: "13", area: "area.EastShroud", pos: { x: 22, y: 26 }, weather: "weather.FairSkies", time: [0, 1, 2, 3, 4, 18, 19, 20, 21, 22, 23], action: "action.Lookout", timestr: "18:00~5:00", startHour: 18, endHour: 5 },
