...
export const SightseeingData: ISightseeingGroup[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { id: "63", area: "area.NorthernThanalan", pos: { x: 22, y: 26 }, weathers: ["weather.ClearSkies", "weather.FairSkies"], time: [5, 6, 7], action: "action.Salute", timestr: "5:00~8:00", startHour: 5, endHour: 8 },
