...
const zh_CN: i18nObject = {
    ...
    updatelog: "<ul><li>由于版本更新，“碧空”和“晴朗”、“小雨”和“暴雨”、“小雪”和“暴雪”现在被视为是一样的天气。本指南已经适配相关改动。</li><li>随着 6.0 版本更新，本指南的天气预报功能新增了以下地图：云冠群岛、地衣宫演习场、多玛飞地、扎杜诺尔高原、穹顶皓天、拉札罕、萨维奈岛、加雷马、旧萨雷安、迷津、？？？、？？？、？？？</li></ul>",
    introdution: {
