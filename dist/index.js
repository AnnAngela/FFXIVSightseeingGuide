            ...
            this.$gBus.$on('nearSoonToCompleteGet', (nearSoonToCompleteData) => {
                if (nearSoonToCompleteData.length > 3) {
                    ...
                    if (soon_option.length > 0) {
                        notificationService.sendNotification(this.$i18n.tc('notification.availableSoonTitle', 2, {
                            n: soon_option.length,
                        }), soon_option);
                    }
                    if (now_option.length > 0) {
                        notificationService.sendNotification(this.$i18n.tc('notification.availableNowTitle', 2, {
                            n: now_option.length,
                        }), now_option);
                    }
                }
...
class EorzeaWeather {
    ...
    static getForecast(areaName, seeds) {
        ...
        try {
            let areaRateData = __WEBPACK_IMPORTED_MODULE_1__EorzeaWeatherData__["a" /* default */][areaName];
...
/* harmony default export */ __webpack_exports__["a"] = (EorzeaAreaWeather);
...
let WeatherOverviewPage = class WeatherOverviewPage extends __WEBPACK_IMPORTED_MODULE_0_vue__["default"] {
    ...
    weatherchange() {
        ...
        this.weatherResult = [];
        for (let area in __WEBPACK_IMPORTED_MODULE_4__EorzeaWeatherData__["a" /* default */]) {
...
class NotificationServiceSet extends Set {
    ...
    delete(value) {
        let isSucceed = Set.prototype.delete.bind(this)();
...
class NotificationService {
    ...
    sendNotification(title, option, isQueued = false) {
        if (this.permission === true) {
            if (this.notificationSet.size < 3) {
                let o = this.defaultOption.extend(option);
                let notification = new Notification(title, o);
...
const SightseeingData = [
    {
        ...
        items: [
            ...
            { id: '10', area: 'area.Gridania', subarea: 'area.OldGridania', pos: { x: 10, y: 16 }, weather: 'weather.ClearSkies', time: [0, 1, 2, 3, 4, 22, 23], action: 'action.Lookout', timestr: '22:00~5:00', startHour: 22, endHour: 5 },
            ...
            { id: '15', area: 'area.Uldah', subarea: 'area.UldahThal', pos: { x: 11, y: 11 }, weather: 'weather.Clouds', time: [12, 13, 14, 15], action: 'action.Lookout', timestr: '12:00~16:00', startHour: 12, endHour: 16 },
