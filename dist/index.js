...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(7), __webpack_require__(15).setImmediate))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_class_component__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_class_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_vue_class_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__EorzeaTime__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__NotificationService__ = __webpack_require__(31);
...
let App = class App extends __WEBPACK_IMPORTED_MODULE_0_vue__["default"] {
    ...
    created() {
        ...
        if (__WEBPACK_IMPORTED_MODULE_3__NotificationService__["a" /* NotificationService */].Main.isSupported) {
            let optionTemplate = new __WEBPACK_IMPORTED_MODULE_3__NotificationService__["a" /* NotificationService */].Option({ lang: this.$i18n.locale, icon: './image/logo.png' });
            let notificationService = new __WEBPACK_IMPORTED_MODULE_3__NotificationService__["a" /* NotificationService */].Main({
            ...
            this.$gBus.$on('nearSoonToCompleteGet', (nearSoonToCompleteData) => {
                if (nearSoonToCompleteData.length > 3) {
                    ...
                    notificationService.sendNotification([
                        now_option.extendTitle(this.$tc('notification.availableNowTitle', 2, {
                            n: now_option.length,
                        })),
                        soon_option.extendTitle(this.$tc('notification.availableSoonTitle', 2, {
                    ...
                    notificationService.sendNotification(nearSoonToCompleteData.map((d) => {
                        ...
                        if (d.isStillWaiting)
                            body += this.$t('info.isStillWaiting');
    ...
    tick() {
        let nowet = new __WEBPACK_IMPORTED_MODULE_2__EorzeaTime__["a" /* default */](undefined);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_class_component__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_class_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_vue_class_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Sightseeing__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__SightseeingCounter__ = __webpack_require__(37);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let HomePage = class HomePage extends __WEBPACK_IMPORTED_MODULE_0_vue__["default"] {
    constructor() {
        super(...arguments);
        ...
        this.succeedCounter = {
            ...
            succeedCount: 0,
            allCount: __WEBPACK_IMPORTED_MODULE_2__Sightseeing__["b" /* SightseeingData */].reduce((s, ig) => (s += ig.items.length), 0),
        };
    ...
    created() {
        ...
        this.$gBus.$on('hourChange', (_) => {
            let oldData = this.calcData;
            this.loadGroup(this.activeGroup); // * 本句是至关重要的，其他的待优化
            let newData = this.calcData;
            let nearSoonToCompleteData = [];
            newData.forEach((sightseeing) => {
                oldData.forEach((s) => {
                    if (s.id !== sightseeing.id)
                        return;
                    if (sightseeing.vaildStatus === 'panel-primary') {
                        if (s.vaildStatus === 'panel-info')
                            nearSoonToCompleteData.push(sightseeing);
                        else if (s.vaildStatus === 'panel-primary' && s.isStillWaiting === true && sightseeing.isStillWaiting === false)
                            nearSoonToCompleteData.push(sightseeing);
                    }
                });
            });
    ...
    loadGroup(index) {
        ...
        this.succeedCounter.activeGroupCount = this.succeedSightseeingCounter.countByGroup(__WEBPACK_IMPORTED_MODULE_2__Sightseeing__["b" /* SightseeingData */][this.activeGroup]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__EorzeaTime__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__EorzeaWeatherData__ = __webpack_require__(12);


class EorzeaWeather {
    static calcBaseDate(time) {
        let tempDate = new __WEBPACK_IMPORTED_MODULE_0__EorzeaTime__["a" /* default */](time.date.getTime());
    ...
    static forecastSeed(time, initSeeds = [0]) {
    ...
    static getForecast(areaName, seeds) {
        ...
        try {
            let areaRateData = __WEBPACK_IMPORTED_MODULE_1__EorzeaWeatherData__["a" /* EorzeaAreaWeather */][areaName];
...
/* harmony export (immutable) */ __webpack_exports__["a"] = EorzeaWeather;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = EorzeaAreaWeather;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_class_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_vue_class_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__EorzeaTime__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__EorzeaWeather__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__EorzeaWeatherData__ = __webpack_require__(12);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let WeatherOverviewPage = class WeatherOverviewPage extends __WEBPACK_IMPORTED_MODULE_0_vue__["default"] {
    constructor() {
        super(...arguments);
        this.hourString = []; //基准时间
        this.weatherResult = [];
    }
    created() {
        this.weatherchange();
        this.$gBus.$on("weatherChange", (_) => {
            this.weatherchange();
        });
    }
    weatherchange() {
        let eorzeaNow = new __WEBPACK_IMPORTED_MODULE_2__EorzeaTime__["a" /* default */](undefined);
        let baseTime = __WEBPACK_IMPORTED_MODULE_3__EorzeaWeather__["a" /* default */].calcBaseDate(eorzeaNow);
        let baseHour = baseTime.getHours() / 8;
        this.hourString = [-1, 0, 1, 2, 3, 4, 5].map(i => baseHour + i).map(bh => timeTag[(bh + 3) % 3]);
        let weatherSeeds = __WEBPACK_IMPORTED_MODULE_3__EorzeaWeather__["a" /* default */].forecastSeed(eorzeaNow, [-1, 0, 1, 2, 3, 4, 5]);
        this.weatherResult = [];
        for (let area in __WEBPACK_IMPORTED_MODULE_4__EorzeaWeatherData__["a" /* EorzeaAreaWeather */]) {
            let forecastedWeather = __WEBPACK_IMPORTED_MODULE_3__EorzeaWeather__["a" /* default */].getForecast(area, weatherSeeds);
...
WeatherOverviewPage = __decorate([
    __WEBPACK_IMPORTED_MODULE_1_vue_class_component___default.a
], WeatherOverviewPage);
/* harmony default export */ __webpack_exports__["a"] = (WeatherOverviewPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__globalBus__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__App_vue__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_home_vue__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_weatheroverview_vue__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__locales_en_US__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__locales_zh_CN__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__locales_ja_JP__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_jquery__ = __webpack_require__(0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_bootstrap__ = __webpack_require__(46);
...
class GlobalBus {
    install(vue) {
        vue.prototype.$gBus = new __WEBPACK_IMPORTED_MODULE_0_vue__["default"]();
    }
}
/* harmony default export */ __webpack_exports__["a"] = (new GlobalBus());
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ts_loader_node_modules_vue_loader_lib_selector_type_script_index_0_App_vue__ = __webpack_require__(9);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_04c2046b_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__ = __webpack_require__(32);
var disposed = false
...
var update = __webpack_require__(4)("0ee47692", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-04c2046b\",\"scoped\":false,\"hasInlineConfig\":false}!../node_modules/sass-loader/lib/loader.js!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./App.vue", function() {
     var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-04c2046b\",\"scoped\":false,\"hasInlineConfig\":false}!../node_modules/sass-loader/lib/loader.js!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./App.vue");
...
// module
exports.push([module.i, "\nhtml {\n  min-height: 100%;\n}\nbody {\n  padding: 70px 0 42px;\n}\nfooter {\n  position: fixed;\n  bottom: 0;\n  width: 100% !important;\n  height: 60px;\n  line-height: 21px;\n  padding-top: 18px;\n  background-image: -webkit-linear-gradient(top, rgba(255, 255, 255, 0), rgba(255, 255, 255, 0.7) 20%, rgba(255, 255, 255, 0.8) 30%, white);\n  background-color: transparent;\n  text-align: center;\n}\n", ""]);
...
module.exports = __webpack_require__.p + "static/fonts/glyphicons-halflings-regular.8988968.svg";
...
(function (NotificationService) {
    ...
    class NSQuitQueue extends Map {
        ...
        _expired(t) {
            let now = t || Date.now() - 13000, result = [];
        ...
        _clearExpriedNotification() {
            let expiredKey = this._expired()[0];
            if (expiredKey) {
    ...
    NotificationService.Option = Option;
    class Main {
        constructor({ welcomeOption, defaultOption }) {
            this.permission = !!("Notification" in window) && Notification.permission === Main.PERMISSION.GRANTED;
            this.defaultOption = new Option();
            this.isOnBeforeunload = false;
            this.NSQuitQueue = new NSQuitQueue();
            this.notificationSet = new NSSet();
    ...
    Main.isSupported = !!("Notification" in window);
    Main.PERMISSION = {
        GRANTED: "granted",
        DENIED: "denied",
        NEEDGRANTED: "default",
    };
    NotificationService.Main = Main;
        ...
        _c("div", { staticClass: "container" }, [
          _c("div", { staticClass: "navbar-header" }, [
            ...
            _c("a", { staticClass: "navbar-brand", attrs: { href: "#" } }, [
              _vm._v("ET " + _vm._s(_vm.eorzeaclock))
            ])
          ]),
          _vm._v(" "),
          _c(
            ...
            [
              _c("ul", { staticClass: "nav navbar-nav" }, [
                ...
                _c(
                  "li",
                  { class: { active: _vm.$route.path == "/weatheroverview" } },
                  [
                    _c("router-link", { attrs: { to: "/weatheroverview" } }, [
                      _vm._v(_vm._s(_vm.$t("info.weatheroverview")))
                    ])
                  ],
                  1
                )
              ...
              _c("ul", { staticClass: "nav navbar-nav navbar-right" }, [
                _c("li", { staticClass: "dropdown" }, [
                  _c(
                    ...
                    [
                      _vm._v(_vm._s(_vm.$t("lang." + _vm.currentLang)) + " "),
                  ...
                  _c("ul", { staticClass: "dropdown-menu" }, [
                    _c("li", [
                      _c(
                        ...
                        [_vm._v(_vm._s(_vm.$t("lang.zh-CN")))]
                      )
                    ]),
                    _vm._v(" "),
                    _c("li", [
                      _c(
                        ...
                        [_vm._v(_vm._s(_vm.$t("lang.en-US")))]
                      )
                    ]),
                    _vm._v(" "),
                    _c("li", [
                      _c(
                        ...
                        [_vm._v(_vm._s(_vm.$t("lang.ja-JP")))]
                      )
                    ])
                  ])
                ])
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ts_loader_node_modules_vue_loader_lib_selector_type_script_index_0_home_vue__ = __webpack_require__(10);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7cbbe74f_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_home_vue__ = __webpack_require__(38);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__ts_loader_node_modules_vue_loader_lib_selector_type_script_index_0_home_vue__["a" /* default */],
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(4)("cf4a1c3e", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7cbbe74f\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/sass-loader/lib/loader.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./home.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7cbbe74f\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/sass-loader/lib/loader.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./home.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__EorzeaTime__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__EorzeaWeather__ = __webpack_require__(11);
...
class Sightseeing {
    ...
    calcNextAvailableTime() {
        let nowet = new __WEBPACK_IMPORTED_MODULE_0__EorzeaTime__["a" /* default */](undefined);
        let baseTime = __WEBPACK_IMPORTED_MODULE_1__EorzeaWeather__["a" /* default */].calcBaseDate(nowet);
        for (let i = 0; i < 10000; i++) {
            let forecastSeed = __WEBPACK_IMPORTED_MODULE_1__EorzeaWeather__["a" /* default */].forecastSeed(baseTime, [i]);
            ...
            if (this.weather === forecast) {
                ...
                if (vaildTimes.length !== 0) {
                    ...
                    this.nextAvaliableTimeLeft = parseInt((this.nextAvaliableTimeEnd.getLocalTime().getTime() - nowet.getLocalTime().getTime())
                        / 1000 / 60 + "", undefined);
                    if (i === 0) {
...
/* harmony export (immutable) */ __webpack_exports__["a"] = Sightseeing;
...
/* harmony export (immutable) */ __webpack_exports__["b"] = SightseeingData;
      ...
      _c(
        ...
        _vm._l(_vm.sourceData, function(item, index) {
          return _c(
            ...
            {
              key: item.groupName,
              class: { active: _vm.activeGroup == index },
              on: {
                click: function($event) {
                  _vm.switchGroup(index)
                }
              }
            },
            [
            ...
            _c("div", { staticClass: "panel-heading" }, [
              _c("h3", { staticClass: "panel-title" }, [
                ...
                item.subarea != undefined
                  ? _c("span", [_vm._v(_vm._s(_vm.$t(item.subarea)))])
                  : _c("span", [_vm._v(_vm._s(_vm.$t(item.area)))]),
                _vm._v(" "),
                _c("span", [
                  _vm._v("x:" + _vm._s(item.pos.x) + " y:" + _vm._s(item.pos.y))
                ]),
                _vm._v(" "),
                _c("img", {
                ...
                _vm._v(" "),
                _c("span", [_vm._v(_vm._s(item.timestr))]),
                _vm._v(" "),
                _c("span", [_vm._v(_vm._s(_vm.$t(item.action)))])
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "pull-right panel-postheader" }, [
                item.vaildStatus == "panel-primary"
                  ? _c("span", [_vm._v(_vm._s(_vm.$t("info.soonToComplete")))])
                  : _vm._e(),
                _vm._v(" "),
                item.vaildStatus == "panel-info"
                  ? _c("span", [
                      _vm._v(_vm._s(_vm.$t("info.fewHoursToComplete")))
                    ])
                  : _vm._e(),
                _vm._v(" "),
                item.vaildStatus == "panel-warning"
                  ? _c("span", [
                      _vm._v(_vm._s(_vm.$t("info.moreTimeToComplete")))
                    ])
                  : _vm._e(),
                _vm._v(" "),
                item.vaildStatus == "panel-default"
                  ? _c("span", [
                      _vm._v(_vm._s(_vm.$t("info.longTimeToComplete")))
                    ])
                  : _vm._e(),
                _vm._v(" "),
                item.vaildStatus == "panel-danger"
                  ? _c("span", [
                      _vm._v(_vm._s(_vm.$t("info.veryLongTimeToComplete")))
                    ])
                  : _vm._e(),
                _vm._v(" "),
                item.vaildStatus == "panel-success"
                  ? _c("span", [_vm._v(_vm._s(_vm.$t("info.completed")))])
                  : _vm._e()
              ])
            ]),
            _vm._v(" "),
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ts_loader_node_modules_vue_loader_lib_selector_type_script_index_0_weatheroverview_vue__ = __webpack_require__(13);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_78c4d72d_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_weatheroverview_vue__ = __webpack_require__(42);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__ts_loader_node_modules_vue_loader_lib_selector_type_script_index_0_weatheroverview_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_78c4d72d_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_weatheroverview_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src\\components\\weatheroverview.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-78c4d72d", Component.options)
  } else {
    hotAPI.reload("data-v-78c4d72d", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(4)("4c96680e", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-78c4d72d\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/sass-loader/lib/loader.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./weatheroverview.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-78c4d72d\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/sass-loader/lib/loader.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./weatheroverview.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("div", [
    _c("h3", [_vm._v(_vm._s(_vm.$t("info.weatheroverview")))]),
    _vm._v(" "),
    _c("table", { staticClass: "table table-striped table-hover" }, [
      _c("thead", [
        _c("tr", [
          _c("th", [_vm._v(_vm._s(_vm.$t("info.area")))]),
          _vm._v(" "),
          _c("th", [
            _vm._v(_vm._s(_vm.$t("info.before"))),
            _c("br"),
            _vm._v(_vm._s(_vm.hourString[0]) + "~")
          ]),
          _vm._v(" "),
          _c("th", [
            _vm._v(_vm._s(_vm.$t("info.now"))),
            _c("br"),
            _vm._v(_vm._s(_vm.hourString[1]) + "~")
          ]),
          _vm._v(" "),
          _c("th", [_vm._v(_vm._s(_vm.hourString[2]) + "~")]),
          _vm._v(" "),
          _c("th", [_vm._v(_vm._s(_vm.hourString[3]) + "~")]),
          _vm._v(" "),
          _c("th", [_vm._v(_vm._s(_vm.hourString[4]) + "~")]),
          _vm._v(" "),
          _c("th", [_vm._v(_vm._s(_vm.hourString[5]) + "~")]),
          _vm._v(" "),
          _c("th", [_vm._v(_vm._s(_vm.hourString[6]) + "~")])
        ])
      ]),
      _vm._v(" "),
      _c(
        "tbody",
        _vm._l(_vm.weatherResult, function(item) {
          return _c("tr", { key: item.name }, [
            _c("td", [_vm._v(_vm._s(_vm.$t(item.name)))]),
            _vm._v(" "),
            _c("td", [
              _c("img", {
                staticClass: "weatherImg",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-78c4d72d", esExports)
  }
}
...
/* harmony default export */ __webpack_exports__["a"] = (en_US);
...
/* harmony default export */ __webpack_exports__["a"] = (zh_CN);
...
/* harmony default export */ __webpack_exports__["a"] = (ja_JP);
